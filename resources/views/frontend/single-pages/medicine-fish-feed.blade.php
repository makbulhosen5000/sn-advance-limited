            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-service-two "  style=" background-color:#F2F4F8;">
                         <a href=""> <img src="{{asset('public/images/medicine/'.$medicine->image)}}" width="280px" height="200px" alt="Image"></a>
                         <h5 style="color:#23232c;;padding-top:10px;font-family: Poppins;font-weight: 400;font-size: 20px;line-height: 2.14286">{{$medicine->name}}</h5>
                         <h5 style="color:#1e1e23;;font-weight: 600;line-height: 30px;" >Price: BDT {{$medicine->price}}</h5>
                        ...
                        <div class="service-page-link- text-center">
                            <a href="{{route('contact.us',$medicine->slug)}}" class=" btn btn-outline-secondary"><i class="fas fa-shopping-cart pr-2"></i>GET A QUOTE</a>
                        </div>
                    </div>                  
                </div>
                @endforeach
