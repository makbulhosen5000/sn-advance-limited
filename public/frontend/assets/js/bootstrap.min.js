...
! function(t, e) {
    ...
    var c = {
        ...
        jQueryDetection: function() {
            if ("undefined" == typeof e) throw new TypeError("Bootstrap's PackingScript requires jQuery. jQuery must be included before Bootstrap's PackingScript.");
            var t = e.fn.jquery.split(" ")[0].split(".");
            if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || t[0] >= 4) throw new Error("Bootstrap's PackingScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }
    };
